...
use CDNServer\Core\Entity\UserGroup;
use CDNServer\Core\Form\UserGroupType;
...
class UserGroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CDNServerCore:UserGroup')->findAll();

        return $this->render('CDNServerCore:Admin/UserGroup:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CDNServerCore:Admin/UserGroup:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CDNServerCore:UserGroup')->find($id);
        ...
        return $this->render('CDNServerCore:Admin/UserGroup:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CDNServerCore:Admin/UserGroup:edit.html.twig', array(
            'entity'      => $entity,
